# AutoKaggler runtime contract

Read this detailed project contract when modifying pipeline or profile behavior.
The bootstrap code is illustrative; do not execute it for unrelated tasks.
Repository authorization and delivery follow `../AGENTS.md`; generating a valid
submission file does not itself authorize submission to Kaggle.
